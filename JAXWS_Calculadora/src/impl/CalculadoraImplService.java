 ...
 * 
 */
@WebServiceClient(name = "CalculadoraImplService", targetNamespace = "http://impl/", wsdlLocation = "http://localhost:1515/WS/Calculadora?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULADORAIMPLSERVICE_QNAME = new QName("http://impl/", "CalculadoraImplService");
    ...
    public Calculadora getCalculadoraImplPort() {
        return super.getPort(new QName("http://impl/", "CalculadoraImplPort"), Calculadora.class);
    }
    ...
    public Calculadora getCalculadoraImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl/", "CalculadoraImplPort"), Calculadora.class, features);
    }
