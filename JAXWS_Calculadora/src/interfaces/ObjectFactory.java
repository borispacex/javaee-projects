...
public class ObjectFactory {
    ...
    private final static QName _Operation_QNAME = new QName("http://interfaces/", "operation");
    private final static QName _OperationResponse_QNAME = new QName("http://interfaces/", "operationResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces/", name = "operation")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces/", name = "operationResponse")
